...
class MealProvider{
  final List<Meal> _mealData = [
    Meal(
        ...
        imageUrl: 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.lzfKGy37KNRMwzB6dxRkRwHaFj%26pid%3DApi&f=1',
        categories: ['c7', 'c10'],
        ingredients: [
          '3/4 cup sugar',
    ...
    Meal(id: 'm11',
        ...
        imageUrl: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimg1.cookinglight.timeinc.net%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2F1530030147%2Fchicken-and-bulgur-salad-with-peaches-1808-p17.jpg%3Fitok%3D8fVFDY9-',
        categories: ['c7'],
        ingredients: [
          '1 1/3 cups water',
          '2/3 cup bulgur',
  ...
  void getMealCategory(String id){
    mealItem.where((meal) => meal.categories.contains(id)).toList();
  }
}
